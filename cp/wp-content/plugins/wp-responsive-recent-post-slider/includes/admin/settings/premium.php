...
<div class="wrap">
	...
	<div class="essential-plugin-bundle">
		<a href="https://www.wponlinesupport.com/wp-plugin/wp-responsive-recent-post-slider/?ref=WposPratik&utm_source=WP&utm_medium=Postslider&utm_campaign=Essential-Plugin-Banner" target="_blank"><img src="https://www.wponlinesupport.com/plugin-data-api/images/plugin-bundle-banner.png?time=<?php echo current_time('timestamp'); ?>" alt="essential-plugin-bundle" /></a>
	</div>
	...
	<table class="wpos-plugin-pricing-table">
		...
		<colgroup></colgroup>	
	    	...
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>WP Responsive Recent Post Slider</strong> included in <br /><strong>Utility OR Essential Plugin Bundle</p>
	     ...
	     <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>WP Responsive Recent Post Slider</strong> included in <br /><strong>Utility OR Essential Plugin Bundle</p>
				<a href="https://www.wponlinesupport.com/wp-plugin/wp-responsive-recent-post-slider/?ref=WposPratik&utm_source=WP&utm_medium=Postslider&utm_campaign=Upgrade-PRO" target="_blank">View Buying Options</a></td>
	    	</tr>
	    </tfoot>
